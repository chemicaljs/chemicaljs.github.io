...
<Table className="not-prose">
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>add with no value for true</TableCell>
    ...
    <TableRow>
      <TableCell>data-service-store</TableCell>
      <TableCell>add with no value for true</TableCell>
      <TableCell className="text-right">Use store for service.</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>data-autoHttps-store</TableCell>
      <TableCell>add with no value for true</TableCell>
      <TableCell className="text-right">Use store for autoHttps.</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>data-searchEngine-store</TableCell>
      <TableCell>add with no value for true</TableCell>
      <TableCell className="text-right">Use store for searchEngine.</TableCell>
    </TableRow>
  </TableBody>
</Table>
